...
describe('MetadataDBService Integration Tests', () => {
  ...
  it('should find similar candidates based on LSH keys', () => {
    ...
    const pHash3 = 'ffff1122aaaaaaaa'; // Shares 'ffff' with pHash1 and '1122' with pHash2
    ...
    // LSH Keys for pHash3: ['ffff', '1122', 'aaaa', 'aaaa']
    const lshKeys3 = ['ffff', '1122', 'aaaa', 'aaaa'];
    ...
    // Should find image1 (shares 'ffff') and image2 (shares '1122')
