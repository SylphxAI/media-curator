...
const mockComparator = new MediaComparator(
  {} as any,
  {} as any,
  {} as any,
  {} as any,
...
const mockFileInfoA: FileInfo = {
  fileStats: { hash: mockSAB, size: 100 } as FileStats,
  metadata: {} as Metadata,
  media: { duration: 0, frames: [{ hash: mockSAB, timestamp: 0 }] },
};
const mockFileInfoB: FileInfo = {
  fileStats: { hash: mockSAB, size: 110 } as FileStats,
  metadata: {} as Metadata,
  media: { duration: 0, frames: [{ hash: mockSAB, timestamp: 0 }] },
};
const mockFileInfoC: FileInfo = {
  fileStats: { hash: mockSAB, size: 120 } as FileStats,
  metadata: {} as Metadata,
...
describe('deduplicateFilesFn', () => {
  ...
  >;
  let mockedGetAdaptiveThreshold: ReturnType<
    typeof vi.mocked<typeof comparatorUtils.getAdaptiveThreshold>
  >;
  let mockedBufferToSAB: ReturnType<
    typeof vi.mocked<typeof utils.bufferToSharedArrayBuffer>
  >;
  ...
  beforeEach(async () => {
    ...
    mockedBufferToSAB.mockImplementation(
  ...
  it('should handle only exact duplicates', async () => {
    ...
    mockedGetMultipleFileInfo.mockResolvedValue(
      ok(
  ...
  it('should handle only similarity duplicates', async () => {
    ...
    mockedCalculateSimilarity.mockImplementation(
      (info1: MediaInfo, info2: MediaInfo) => {
        ...
        if (
          (compareSAB(hash1, hashA1SAB) && compareSAB(hash2, hashA2SAB)) ||
    ...
    const mergeArgs = mockedMergeClusters.mock.calls[0][0];
