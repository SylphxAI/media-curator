...
<p align="center">
  <img src="https://mark.sylphx.com/api/v1/mark/hero?type=silk&theme=tokyonight&text=media+curator&desc=Intelligently+organizes+and+deduplicates+large+digital+photo+and+video+collections+using+metadata%E2%80%A6&height=200&animation=rise" alt="media-curator — Sylphx Mark banner" width="100%" />
</p>
